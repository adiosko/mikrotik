...
qtCreatorFile = "addDstAccept.ui"

Ui_MainWindow, QtBaseClass = uic.loadUiType(qtCreatorFile)

class addDstAcceptGui(QtGui.QMainWindow,Ui_MainWindow):
