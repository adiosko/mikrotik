...
class bridgeFilterAdvanced:
    ...
    def setVlanPriority(self, number, vlan="1"):
        ...
        :return:
        """
        vlan = self.client.talk( ['/interface/bridge/filter/set', '=numbers=' + number, '=vlan-priority=' + vlan] )
        return vlan
    ...
    def setVlanEncap(self, number, vlan="ip"):
        ...
        :return:
        """
        vlan = self.client.talk( ['/interface/bridge/filter/set', '=numbers=' + number, '=vlan-encap=' + vlan] )
        return vlan
    ...
    def set8023Sap(self,number,vlan="0"):
        ...
        :return:
        """
        vlan = self.client.talk( ['/interface/bridge/filter/set', '=numbers=' + number, '=802.3-sap=' + vlan] )
        return vlan
    ...
    def set8023Type(self, number, vlan="0"):
        ...
        :return:
        """
        vlan = self.client.talk( ['/interface/bridge/filter/set', '=numbers=' + number, '=802.3-type=' + vlan] )
        return vlan
    ...
    def setPacketType(self,number,packet="host"):
        ...
        :return:
        """
        vlan = self.client.talk( ['/interface/bridge/filter/set', '=numbers=' + number, '=packet-type=' + packet] )
        return vlan
    ...
    def setLimitRateFilter(self, number, rate="1/se", burst="5"):
        ...
        """
        ip = self.client.talk(
            ['/interface/bridge/filter/set', '=numbers=' + number, '=limit=' + rate + "," + burst] )
        return ip
    ...
    def setTimeFilter(self, number, fromDate="00:00:00", toDate="1d 00:00:00", day="mon,tue"):
        ...
        """
        ip = self.client.talk(
            ['/interface/bridge/filter/set', '=numbers=' + number, "=time=" + fromDate + "," + toDate + "," + day] )
        return ip
